...
# /AI/llama.cpp/build/bin/llama-server -ngl 999 --jinja -c 262144  --host 0.0.0.0  --port 5000 -fa 1 --temp 1.0 --top_p 0.95 --top_k 20 --min_p 0.0 --repeat-penalty 1.0 --presence-penalty 0.0  --chat-template-kwargs '{"reasoning_effort": "xhigh"}' --image-min-tokens 1024 --reasoning-preserve --parallel 1  --model /AI/models/Qwen3.8-Flash-Next-Uncensored.IQ4_XS.gguf  --mmproj /AI/models/mmproj-Qwen3.8-Flash-Next-Uncensored-BF16.gguf
# MODELS used:
# /AI/models/Qwen3.8-Flash-Next-Uncensored.IQ4_XS.gguf  --mmproj /AI/models/mmproj-Qwen3.8-Flash-Next-Uncensored-BF16.gguf
